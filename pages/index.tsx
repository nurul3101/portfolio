          ...
          <div className="flex flex-col-reverse sm:flex-row items-start">
            <div className="flex flex-col pr-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-16">
                I'm a Software Engineer / Web Developer. I help people make the
                world better through quality software. I am an avid learner and
                try to explain things with words and code.
              </p>
            </div>
